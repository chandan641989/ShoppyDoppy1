...
public class Categories extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String URL = "http://kart.webvalleytech.com/web.asmx/getcategory";
            ...
            if (integer == 1){
                ...
                adapter.setOnItemClickLIstener(new OnItemClickLIstener() {
                    ...
                    public void OnItemClick(FeedItems feedItem) {
                       // Toast.makeText(getApplicationContext(),"Item clicked"+feedItem.getTitle(),Toast.LENGTH_LONG).show();
                        String s=feedItem.getTitle();
                        Intent in = new Intent(getApplicationContext(),SubCategories.class);
                        in.putExtra("title",s);
    //                   SharedPreferences mPrefs = getSharedPreferences("cat", MODE_PRIVATE);
//                       SharedPreferences.Editor editor = mPrefs.edit();
//                        editor.putString("title", feedItem.getTitle().toString());
//                        editor.commit();
                       startActivity(in);
    ...
    private void parseResult(String s) throws JSONException {
        ...
        for (int i =0;i<result.length();i++){
            ...
            item.setTitle(product.optString("name"));
